...
const envSchema = z.object({
  ...
  OPENAI_TTS_KO_MALE_VOICE: z.string().min(1).optional(),
  OPENAI_TTS_KO_FEMALE_VOICE: z.string().min(1).optional(),
...
export function getServerEnv() {
  ...
  parsedEnv = envSchema.parse({
    ...
    OPENAI_TTS_KO_MALE_VOICE: process.env.OPENAI_TTS_KO_MALE_VOICE,
    OPENAI_TTS_KO_FEMALE_VOICE: process.env.OPENAI_TTS_KO_FEMALE_VOICE,
